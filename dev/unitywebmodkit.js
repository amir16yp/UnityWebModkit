...
function maybeDecompressUnityWebData(buffer) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (format === "brotli") {
            const compression = (_a = window.UnityLoader) === null || _a === void 0 ? void 0 : _a.Compression;
            const decompress = compression === null || compression === void 0 ? void 0 : compression.decompress;
...
class Runtime {
    ...
    onWebAssemblyInstantiate(bufferSource, importObject) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.logger.info("Found %d image definitions, proceeding with modding", ((_b = this.globalMetadata) === null || _b === void 0 ? void 0 : _b.imageDefs.length) || 0);
            let arrayBuffer;
            if (bufferSource instanceof ArrayBuffer) {
                arrayBuffer = bufferSource;
            }
            else if (ArrayBuffer.isView(bufferSource)) {
                arrayBuffer = bufferSource.buffer.slice(bufferSource.byteOffset, bufferSource.byteOffset + bufferSource.byteLength);
            }
            else {
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("b8048501b6d8aa50d5cd")
/******/ 	})();
/******/ 	
